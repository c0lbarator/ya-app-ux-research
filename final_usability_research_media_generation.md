...
Тестировал в два захода: сначала руками, собрав стартовый список найденных недочётов, потом — экспериментально — ИИ-агентом (Gemini 3.8 Flash, Google Antigravity), которому дал доступ к [документации](https://yandex.com.tr/support/yandex-ai-app/en/) приложения и к самому установленному приложению через uiautomator для самостоятельного UX-теста. Агент нашёл дополнительные баги и упаковал всё в формат UX-аудита по методологиям, о которых я как раз узнал на первой лекции курса по UX за день до исследования😄. Дальше я это провалидировал, поправил оценки и формулировки — так и получился этот документ.
