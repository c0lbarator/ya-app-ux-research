...
> [!NOTE]
> Само исследование начинается [[final_usability_research_media_generation#2. Оцифровка пользовательского пути (Customer Journey Map & User Flow)|тут]], здесь предисловие, которое можно прочитать, если интересно
